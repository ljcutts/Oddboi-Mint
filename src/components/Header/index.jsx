    ...
    <header className="border-b border-[#8e8e8e] w-full flex justify-center">
      <div className="max-w-screen-2xl w-full flex justify-between py-2 px-1 md:p-5">
        ...
        <div className="flex items-center gap-2 md:gap-6">
          ...
          {isConnected ? (
            <button className="bg-[#FFB800] flex justify-center items-center font-extrabold p-[15px] h-[40px] text-[#000] rounded-[8px]">
              {address.slice(0, 5) + " ... " + address.slice(-5)}
            </button>
          ) : (
            <button
              onClick={connectWallet}
              className="bg-[#FFB800] flex justify-center items-center font-extrabold p-[15px] h-[40px] text-[#000] rounded-[8px]"
            >
              Connect Wallet
            </button>
          )}
        ...
        {/* Mobile Menu */}
        {drawer && (
          <div className="bg-[#000000f4] flex flex-col py-4 justify-between fixed bottom-0 right-0 left-0 top-0">
            ...
            <ul className="w-full py-10 gap-7 text-[23px] flex justify-center flex-col items-center">
              <Link
