...
const Footer = () => {
  return (
    <section className="w-full flex justify-center border-t border-[#8e8e8e]">
      <div className="px-2 max-w-screen-2xl w-full pt-14 pb-5 flex-col flex items-center">
        {/* Icons */}
        <ul className="flex gap-10">
          <a
            href="https://opensea.io/collection/odd-boog"
            target="_blanc"
            rel="noreferer"
          >
            <li>
          ...
          <a
            href="https://twitter.com/oDDbOOG"
            target="_blanc"
            rel="noreferer"
          >
            {" "}
        ...
        <ul className="flex text-white gap-10 mt-10 mb-4">
          <a
            href="https://aatmastudio.com"
            target="_blanc"
            rel="noreferer"
          >
            <li className="font-bold">oDD COMPANY</li>
          </a>

          <a
            href="https://medium.com/@oddverse"
            target="_blanc"
            rel="noreferer"
          >
            <li className="font-bold">oDD Paper</li>
          </a>

          <a
            href="https://docs.google.com/document/d/1UPTmWB4aGbKEHHW3UO87hckSRca84uU0lV8Bg70gmgk/edit?usp=sharing"
            target="_blanc"
            rel="noreferer"
          >
        ...
        <span className="text-center">
          ...
          <span className="text-[#4242ff] underline">hi@oddverse.xyz</span>{" "}
        </span>
      </div>
    </section>
  );
